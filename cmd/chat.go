...
If you mention or provide a YAML file, it will read that file and give more context-aware command suggestions.`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		// Öncelik: --file flag'i varsa onu oku
		if chatInputFile != "" {
			...
			// prompt içinde .yaml geçiyorsa otomatik olarak dosyayı bulmaya çalış
...
- "kubectl get pods --namespace=my-namespace"`
		...
		// Eğer yaml içeriği varsa, prompt'a bağlam olarak ekle
		if yamlContent != "" {
